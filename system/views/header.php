		...
		<div class="content">
			...
			<div class="logo">
				<a href="{$url_base}feed">
					<img src="{$url_base}resources/img/logo.png">
				</a>
			...
			<div class="left">
				...
				<div class="login_pessoal">
					<div class="menu">
						<img src="{$url_base}resources/img/icone_menu.png">
						<ul>
							<li><a href="{$url_base}config">Configuração</a></li>
							<li><a href="{$url_base}logout">Sair</a></li>
						</ul>
					</div>
					<a href="{$url_base}feed/{$usuario_logado['url_user']}">
						<img class="foto" src="{$usuario_logado['foto_user']}">
					</a>
